...
\abstract{
Teaching students the fundamentals of programming is not an easy task at all. Luckily, there are useful tools like Stack and Heap diagrams that facilitate this process by allowing them  to really understand what they are doing when writing some code. However, these diagrams are often drawn either on paper or with legacy software that does not feel adequate in 2020. In this project, I developed a web-based stack and heap graphical editor, using modern front-end web technologies like React and Sass.}
